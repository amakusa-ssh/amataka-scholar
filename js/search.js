...
<li class="py-4">
    <div class="bg-white rounded-md border p-4">
        ...
        <div class="flex justify-end">
            <a href="javascript:void(0)" onclick="openPdf(${datas[i].pdfUrl })" class="w-32 text-center bg-yellow-400 hover:bg-yellow-300 text-black p-2 rounded-md shadow-md">開く</a>
        </div>
    </div>
</li>
            `;
